...
/**
 * REST controller for managing {@link Price}.
 */
@RestController
@RequestMapping("/api")
public class PriceResource {
    ...
    private static final String ENTITY_NAME = "paymentServicePrice";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/prices/{id}", consumes = "application/merge-patch+json")
